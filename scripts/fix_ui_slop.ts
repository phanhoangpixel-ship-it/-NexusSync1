...
const filesToFix = [
  ...
  "src/modules/admin/m04-super-admin/components/SuperAdminRBACWorkspace.tsx",
  "src/modules/governance/m38-hr/components/HRWorkspace.tsx",
  "src/modules/governance/m38-hr/components/PayrollCalculationGLModal.tsx",
  "src/modules/admin/m01-workspace-hub/components/UnifiedActivityTaskDrawer.tsx"
];
