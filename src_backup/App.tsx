...
const WorkspaceHub = lazy(() => import('./components/workspaces/WorkspaceHub').then(m => ({ default: m.WorkspaceHub })));
const MasterWmsWorkspace = lazy(() => import('./components/workspaces/MasterWmsWorkspace').then(m => ({ default: m.MasterWmsWorkspace })));
const WarehouseManagementWorkspace = lazy(() => import('./components/workspaces/WarehouseManagementWorkspace').then(m => ({ default: m.WarehouseManagementWorkspace })));
const StockAdjustmentWorkspace = lazy(() => import('./components/workspaces/StockAdjustmentWorkspace').then(m => ({ default: m.StockAdjustmentWorkspace })));
const M21InternalTransfersWorkspace = lazy(() => import('./components/workspaces/M21InternalTransfersWorkspace').then(m => ({ default: m.M21InternalTransfersWorkspace })));
const M22LotsBatchesWorkspace = lazy(() => import('./components/workspaces/M22LotsBatchesWorkspace').then(m => ({ default: m.M22LotsBatchesWorkspace })));
const M23SerialsWorkspace = lazy(() => import('./components/workspaces/M23SerialsWorkspace').then(m => ({ default: m.M23SerialsWorkspace })));
const M24WMSExtendedWorkspace = lazy(() => import('./components/workspaces/M24WMSExtendedWorkspace').then(m => ({ default: m.M24WMSExtendedWorkspace })));
const ManufacturingWorkspace = lazy(() => import('./components/workspaces/ManufacturingWorkspace').then(m => ({ default: m.ManufacturingWorkspace })));
const SupplyChainWorkspace = lazy(() => import('./components/workspaces/SupplyChainWorkspace').then(m => ({ default: m.SupplyChainWorkspace })));
const AssetMaintenanceWorkspace = lazy(() => import('./modules/assets/m27-eam/components/AssetMaintenanceWorkspace').then(m => ({ default: m.AssetMaintenanceWorkspace })));
const HRWorkspace = lazy(() => import('./modules/hr/m28-hr-payroll/components/HRWorkspace').then(m => ({ default: m.HRWorkspace })));
const DMSWorkspace = lazy(() => import('./components/workspaces/DMSWorkspace').then(m => ({ default: m.DMSWorkspace })));
const EHSWorkspace = lazy(() => import('./modules/governance/m40-ehs/components/EHSWorkspace').then(m => ({ default: m.EHSWorkspace })));
const M41PricingManagementWorkspace = lazy(() => import('./components/workspaces/M41PricingManagementWorkspace').then(m => ({ default: m.M41PricingManagementWorkspace })));
const ServiceDeskWorkspace = lazy(() => import('./modules/governance/m38-service-desk/components/ServiceDeskWorkspace').then(m => ({ default: m.ServiceDeskWorkspace })));
const M39QualityControlWorkspace = lazy(() => import('./components/workspaces/M39QualityControlWorkspace').then(m => ({ default: m.M39QualityControlWorkspace })));
const AuditComplianceWorkspace = lazy(() => import('./components/workspaces/AuditComplianceWorkspace').then(m => ({ default: m.AuditComplianceWorkspace })));
const SystemSettingsWorkspace = lazy(() => import('./components/workspaces/SystemSettingsWorkspace').then(m => ({ default: m.SystemSettingsWorkspace })));
const SuperAdminRBACWorkspace = lazy(() => import('./components/workspaces/SuperAdminRBACWorkspace').then(m => ({ default: m.SuperAdminRBACWorkspace })));
const M05EventBusWorkspace = lazy(() => import('./components/workspaces/M05EventBusWorkspace').then(m => ({ default: m.M05EventBusWorkspace })));
const M06InnovationRDWorkspace = lazy(() => import('./components/workspaces/M06InnovationRDWorkspace').then(m => ({ default: m.M06InnovationRDWorkspace })));
const M07CustomersItemMasterWorkspace = lazy(() => import('./components/workspaces/M07CustomersItemMasterWorkspace').then(m => ({ default: m.M07CustomersItemMasterWorkspace })));
const M08PurchaseOrdersWorkspace = lazy(() => import('./components/workspaces/M08PurchaseOrdersWorkspace').then(m => ({ default: m.M08PurchaseOrdersWorkspace })));
const M09SuppliersSRMWorkspace = lazy(() => import('./components/workspaces/M09SuppliersSRMWorkspace').then(m => ({ default: m.M09SuppliersSRMWorkspace })));
const M10StrategicSourcingWorkspace = lazy(() => import('./components/workspaces/M10StrategicSourcingWorkspace').then(m => ({ default: m.M10StrategicSourcingWorkspace })));
const M11SrmSupplierMgmtWorkspace = lazy(() => import('./components/workspaces/M11SrmSupplierMgmtWorkspace').then(m => ({ default: m.M11SrmSupplierMgmtWorkspace })));
const M12CrmLeadsWorkspace = lazy(() => import('./components/workspaces/M12CrmLeadsWorkspace').then(m => ({ default: m.M12CrmLeadsWorkspace })));
const M13SalesOrdersWorkspace = lazy(() => import('./components/workspaces/M13SalesOrdersWorkspace').then(m => ({ default: m.M13SalesOrdersWorkspace })));
const M14SalesCommissionWorkspace = lazy(() => import('./components/workspaces/M14SalesCommissionWorkspace').then(m => ({ default: m.M14SalesCommissionWorkspace })));
const M15ReturnsRMAWorkspace = lazy(() => import('./components/workspaces/M15ReturnsRMAWorkspace').then(m => ({ default: m.M15ReturnsRMAWorkspace })));
const M16POSRetailWorkspace = lazy(() => import('./components/workspaces/M16POSRetailWorkspace').then(m => ({ default: m.M16POSRetailWorkspace })));
const M19StocktakeWorkspace = lazy(() => import('./components/workspaces/M19StocktakeWorkspace').then(m => ({ default: m.M19StocktakeWorkspace })));
const M30GeneralLedgerWorkspace = lazy(() => import('./components/workspaces/M30GeneralLedgerWorkspace').then(m => ({ default: m.M30GeneralLedgerWorkspace })));
const M31InvoicesArApWorkspace = lazy(() => import('./components/workspaces/M31InvoicesArApWorkspace').then(m => ({ default: m.M31InvoicesArApWorkspace })));
const M32PaymentsTreasuryWorkspace = lazy(() => import('./components/workspaces/M32PaymentsTreasuryWorkspace').then(m => ({ default: m.M32PaymentsTreasuryWorkspace })));
const M33BankReconciliationWorkspace = lazy(() => import('./components/workspaces/M33BankReconciliationWorkspace').then(m => ({ default: m.M33BankReconciliationWorkspace })));
const M34FinancialConsolidationWorkspace = lazy(() => import('./components/workspaces/M34FinancialConsolidationWorkspace').then(m => ({ default: m.M34FinancialConsolidationWorkspace })));
const M35ProjectsWBSWorkspace = lazy(() => import('./components/workspaces/M35ProjectsWBSWorkspace').then(m => ({ default: m.M35ProjectsWBSWorkspace })));
const M36LogisticsWorkspace = lazy(() => import('./modules/logistics/m36-logistics-fleet/components/M36LogisticsWorkspace').then(m => ({ default: m.M36LogisticsWorkspace })));
const M37BiAnalyticsWorkspace = lazy(() => import('./components/workspaces/M37BiAnalyticsWorkspace').then(m => ({ default: m.M37BiAnalyticsWorkspace })));
const M42CostAllocationWorkspace = lazy(() => import('./components/workspaces/M42CostAllocationWorkspace').then(m => ({ default: m.M42CostAllocationWorkspace })));
const GenericModuleWorkspace = lazy(() => import('./components/workspaces/GenericModuleWorkspace').then(m => ({ default: m.GenericModuleWorkspace })));
