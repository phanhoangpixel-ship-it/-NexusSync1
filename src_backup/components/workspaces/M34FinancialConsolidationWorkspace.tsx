...
const INITIAL_ENTITIES: ConsolidationEntity[] = [
  {
    id: 1,
    code: "BR_HO",
...
const INITIAL_ELIMINATIONS: IntercompanyElimination[] = [
  {
    id: 1,
...
const INITIAL_COA_MAPPINGS: CoaMappingRule[] = [
  {
    id: "MAP-001",
...
const INITIAL_IC_MATCHES: IntercompanyMatchItem[] = [
  {
    id: "ICM-101",
    entityA: "BR_HO",
    entityB: "BR_HCM",
...
const INITIAL_ADJUSTMENT_JOURNALS: ConsolidationAdjustmentJournal[] = [
  {
    id: "CAJ-2026-01",
...
const INITIAL_PERIOD_CLOSE_STAGES: PeriodCloseStage[] = [
...
const INITIAL_TRANSFER_PRICING: TransferPricingData = {
