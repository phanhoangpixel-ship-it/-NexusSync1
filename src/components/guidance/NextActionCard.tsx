  ...
  return (
    <>
      <div
        ...
        className={`bg-white rounded-2xl border border-blue-200 shadow-sm overflow-hidden flex flex-col transition-all ${className}`}
      >
        {/* Header with Title & Progressive Disclosure Switcher */}
        <div className="px-5 py-3.5 bg-gradient-to-r from-blue-50/80 via-slate-50 to-indigo-50/50 border-b border-blue-100 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-blue-100 text-blue-800 uppercase tracking-wide">
                  Next Best Action
                </span>
              ...
              <h3 className="text-sm font-bold text-slate-900 tracking-tight leading-tight mt-0.5">
          ...
          <div className="flex items-center bg-white p-1 rounded-xl border border-slate-200 shadow-2xs text-[11px] font-semibold">
            <button
              type="button"
          ...
          {userLevel === 'INTERMEDIATE' && (
            <div className="flex flex-col gap-3.5">
              ...
              <div className="text-xs text-slate-600">
                <span className="font-bold text-slate-700">Tác động quy trình: </span>
          ...
          {userLevel === 'EXPERT' && (
            <div className="flex flex-col gap-3 font-mono text-xs">
              ...
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                <h5 className="font-bold text-slate-800 font-sans text-xs mb-1 flex items-center gap-1.5">
        ...
        <div className="px-5 py-3 bg-slate-50 border-t border-slate-200 flex flex-wrap items-center justify-end gap-3">
