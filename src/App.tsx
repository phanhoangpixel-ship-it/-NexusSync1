...
const AssetMaintenanceWorkspace = lazy(() => import('./components/workspaces/AssetMaintenanceWorkspace').then(m => ({ default: m.AssetMaintenanceWorkspace })));
const HRWorkspace = lazy(() => import('./components/workspaces/HRWorkspace').then(m => ({ default: m.HRWorkspace })));
const DMSWorkspace = lazy(() => import('./components/workspaces/DMSWorkspace').then(m => ({ default: m.DMSWorkspace })));
const EHSWorkspace = lazy(() => import('./components/workspaces/EHSWorkspace').then(m => ({ default: m.EHSWorkspace })));
...
const ServiceDeskWorkspace = lazy(() => import('./components/workspaces/ServiceDeskWorkspace').then(m => ({ default: m.ServiceDeskWorkspace })));
...
const M36LogisticsWorkspace = lazy(() => import('./components/workspaces/M36LogisticsWorkspace').then(m => ({ default: m.M36LogisticsWorkspace })));
